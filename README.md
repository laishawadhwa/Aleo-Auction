...
The bidder with the highest bid wins the auction. At the end the winning bidder can claim their prize for the auction.
...
- **Claim**: In this stage, the winning bidder claims their prize by invoking the `claim` function. This function returns the prize record assigning ownership to the winning bidder.
...
## <a id="step4"></a> Step 5: Claim the prize and conclude the Auction

Call the `claim` transaition function with the winning `Bid` record
